 ...
 * </ul>
 */
@Request(url="https://api.twitter.com/1.1/friendships/create.json", method=HttpMethod.POST, response=@Response(resourceType=TwitterUser, responseType=TwitterResponse))
