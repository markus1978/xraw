 ...
 */
@Request(url="https://api.twitter.com/1.1/direct_messages/new.json", method=HttpMethod.POST, response=@Response(resourceType=TwitterDirectMessage, responseType=TwitterResponse))
@TestMockupRequest
class New {
	/**
